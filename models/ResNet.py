...
def resnet18(num_class=1000, initialize=False):
...
def resnet34(num_class=1000, initialize=False):
...
def resnet50(num_class=1000, initialize=False):
...
def resnet101(num_class=1000, initialize=False):
...
def resnet152(num_class=1000, initialize=False):
